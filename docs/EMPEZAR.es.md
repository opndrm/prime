...
Ejecute el instalador de Mac con el proyecto que se le asignó: `ADAM` o `FRNKLY.ONE`.
...
Buzz es el espacio de conversación del equipo. Úselo para hablar del trabajo y enlazar la incidencia correspondiente de GitHub. Wayfinder/Crew Map organiza el plan de incidencias de GitHub. GitHub sigue siendo el registro oficial para código, ramas, revisiones y solicitudes de extracción.
