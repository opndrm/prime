...
public final class OpenAdaptGuestEngine {
    ...
    private static let completionMarkerName = ".buzzbot-openadapt-complete"
    private static let completionMarkerContents = "buzzbot-openadapt-capture/v1\n"
    ...
    private func logGuestOnly(_ message: String) {
        FileHandle.standardError.write(Data("BuzzBotGuest: \(message)\n".utf8))
    }
