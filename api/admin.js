...
<section><p>Choose your computer and the app assigned to you. Copy its one-click installer, then follow that app’s work card.</p><div class="tabs"><button data-platform="mac" aria-pressed="true">MAC</button><button data-platform="windows" aria-pressed="false">WINDOWS</button></div><div class="tabs"><button data-lane="ADAM" aria-pressed="true">ADAM</button><button data-lane="FRNKLY.ONE" aria-pressed="false">FRNKLY.ONE</button></div><pre><code id="command"></code></pre><button id="copy">COPY INSTALL</button></section>
